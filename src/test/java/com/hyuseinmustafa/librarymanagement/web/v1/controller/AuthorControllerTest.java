...
class AuthorControllerTest {
    ...
    private static final String JSON_CONTENT = "{\"name\": \"asd\"}";
    private final GetAuthorDto dto1 = GetAuthorDto.builder().build();
    private final GetAuthorDto dto2 = GetAuthorDto.builder().build();
