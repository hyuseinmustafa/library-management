...
class LocationControllerTest {
    ...
    private static final String JSON_CONTENT = "{\"roomNumber\":1, \"shelfNumber\":2}";
    private final GetLocationDto dto1 = GetLocationDto.builder().build();
    private final GetLocationDto dto2 = GetLocationDto.builder().build();
    private final ResultMatcher[] matchers = {
            jsonPath("$.id").hasJsonPath(),
            jsonPath("$.roomNumber").hasJsonPath(),
            jsonPath("$.shelfNumber").hasJsonPath()
    };
